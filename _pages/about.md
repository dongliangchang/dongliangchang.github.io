...
I am a first year PhD student, focussing on Computer Vision and Deep Learning, at Pattern Recognition & Intelligent System Laboratory (PRIS) of the University of Beijing University of Posts and Telecommunications (BUPT). My supervisors is Prof. [Zhanyu Ma](http://www.pris.net.cn/introduction/teacher/zhanyu_ma). Prior to that, I worked as a visiting Student at the PRIS, under the supervision of Prof. Zhanyu Ma. I completed my M.E. degree from Lanzhou University of Technology (LUT), majoring in Internet of things engineering, under the supervision of Prof. [Xiao-Xu Li](http://dongliangchang.cn).


News 
------
 + April 2020, Our one paper is accepted at [TIP 2020!]("https://signalprocessingsociety.org/publications-resources/ieee-transactions-image-processing")
 + Mar 2020, Released my paper "Mind the Gap: Enlarging the Domain Gap in Open Set Domain Adaptation " on ArXiv
 	+ [Paper](https://arxiv.org/pdf/2003.03787)
 	+ [Code](https://github.com/dongliangchang/Mutual-to-Separate/)
